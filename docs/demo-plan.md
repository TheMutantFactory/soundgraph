...
every patch pads 1 and 2 are the previous and next entry — no PROG CHANGE
button. On the instruments pads 3–7 start an arpeggio pattern each and pad 8
stops; hold a chord on Poly Five and it arpeggiates. The kit and the game sounds
have entries of their own with pads 3–8 as drums and pads 3–7 as sounds.
