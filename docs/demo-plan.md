...
`examples/banks/axoloti-akai-mpk-mini.json`: 199 entries generated by
`tools/make-mpk-examples.py`, knobs and pads mapped, Poly Five first. Program
Change is the MPK's PROG CHANGE button plus a pad; the bank's "prev-next" mode
makes pad 1 previous, pad 2 next and pad 3 home.
